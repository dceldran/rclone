...
```
2019/08/25 11:40:14 NOTICE: A new release for gui is present at https://github.com/dceldran/rclone-webui-react/releases/download/v0.0.6/currentbuild.zip
...
The GUI is being developed in the: [rclone/rclone-webui-react repository](https://github.com/dceldran/rclone-webui-react).
