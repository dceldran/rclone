...
You can also find a [mirror of the downloads on GitHub](https://github.com/dceldran/rclone/releases/tag/{{< version >}}).
...
[git log](https://github.com/dceldran/rclone/commits/master).  The most
