...
#
# example usage: 
# $GOPATH/src/github.com/dceldran/rclone/cmd/info/test.sh --list | \
#   parallel -P20 $GOPATH/src/github.com/dceldran/rclone/cmd/info/test.sh

export PATH=$GOPATH/src/github.com/dceldran/rclone:$PATH
