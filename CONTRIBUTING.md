...
page](https://github.com/dceldran/rclone).

Now in your terminal

    go get -u github.com/dceldran/rclone
    cd $GOPATH/src/github.com/dceldran/rclone
...
rclone currently uses [GitHub Actions](https://github.com/dceldran/rclone/actions) to build and test the project, which should be automatically available for your fork too from the `Actions` tab in your repository.
...
project root:
    ...
    go install github.com/dceldran/rclone/fstest/test_all
...
[Go reference](https://godoc.org/github.com/dceldran/rclone/lib/plugin)
